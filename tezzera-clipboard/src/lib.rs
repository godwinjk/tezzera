//! OS clipboard integration for TEZZERA.
//!
...
//! # Example
//! ```rust,ignore
//! use tezzera_clipboard::{SystemClipboard, ClipboardProvider};
//!
//! let cb = SystemClipboard::new();
//! cb.write("Hello from TEZZERA").unwrap();
//! let text = cb.read(); // Some("Hello from TEZZERA") on macOS/Linux
//! ```
